...
class Wheel:
    def __init__(self, size=36, number_of_reds=18, number_of_blacks=18, number_of_greens=2):
        ...
        :details: The wheel is made up of 36 slots. Each slot is made up of a color and a number.
        ...
        Combine all these lists into one giant list representing the wheel. That's where random will draw from.
